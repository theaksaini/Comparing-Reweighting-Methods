...
def main():
    ...
    objective_functions_dict = {'analysis/roc_dpd': ['auroc', 'demographic_parity_difference'],
                                'analysis/roc_sfn': ['auroc', 'subgroup_FNR_loss'],
                                'analysis/acc_dpd': ['accuracy', 'demographic_parity_difference'],
                                'analysis/acc_sfn': ['accuracy', 'subgroup_FNR_loss'],}

    results_folder = 'analysis/roc_dpd'
    hv_folder = 'analysis/hv_roc_dpd'

    analyze_hv(task_ids=task_ids, experiments=experiments1, results_folder=results_folder, hv_folder=hv_folder, objective_functions=objective_functions_dict[results_folder])
