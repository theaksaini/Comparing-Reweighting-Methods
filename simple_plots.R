rm(list = ls())
cat("\014")
setwd('~/Documents/Projects/reweighing-ga/analysis')
...
hv_file_name <- 'hv_roc_sfn/hv_test.csv'
final_plot_name <- "roc_sfn.pdf"
final_plot_title <- "Hypervolume for Pareto Front (AUROC, Subgroup FN) on Test Set"
